...
export function SiteFooter() {
  return <footer className="site-footer"><div className="section-shell footer-top">
    ...
    <div className="footer-col"><h3>Сервис</h3><Link href="/pricing">Тарифы</Link><Link href="/coupons">Купонный дроп</Link><Link href="/connect">Подключение</Link><Link href="/status">Статус</Link></div>
